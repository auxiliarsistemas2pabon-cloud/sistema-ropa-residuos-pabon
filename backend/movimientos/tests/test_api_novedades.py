...
def test_lista_novedades_filtra_por_tipo(api_client, administradora, usuario, crear_movimiento):
...
def test_lista_novedades_es_exclusiva_de_la_administradora(api_client, usuario):
    api_client.force_authenticate(user=usuario)
    resp = api_client.get(reverse("api-novedad-list"))
