...
import { registrarPeso } from "../../api/movimientos";
 ...
 * Personal de servicio (que solo cuenta prendas) y quien la recibe la pesa,
 * una sola vez. La persona que pesa queda registrada en el pesaje. */
export function FormularioPeso({ movimientoId, onCancelar }: { movimientoId: number; onCancelar: () => void }) {
